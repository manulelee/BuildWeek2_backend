...
public class MyRunner implements ApplicationRunner {
	...
	public void insertProvince() {
		...
		String filePath = "src/main/resources/province-italiane.csv";
		File file = new File(filePath);
		if (file.exists() && !file.isDirectory()) {
			System.out.println("File exists");
		} else {
			filePath = "Epic_Energy/src/main/resources/province-italiane.csv";
	...
	public void insertMunicipality() {
		...
		String filePath = "src/main/resources/comuni-italiani.csv";
		File file = new File(filePath);
		if (file.exists() && !file.isDirectory()) {
			System.out.println("File exists");
		} else {
			filePath = "Epic_Energy/src/main/resources/comuni-italiani.csv";
			file = new File(filePath);
		}
		;
		String line;
	...
	public void insertCustomer() {
		...
		for (int i = 0; i < 10; i++) {
			...
			String contactEmail = contactName.toLowerCase() + "." + contactLastName.toLowerCase() + "@"
					+ legalName.split(" ")[0].split(",")[0].toLowerCase() + ".com";
